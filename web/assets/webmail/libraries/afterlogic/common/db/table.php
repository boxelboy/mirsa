	...
	public function ToString($oHelper)
	{
		...
		switch ($this->iType)
		{
			case CDbField::AUTO_INT:
				$sResult .= 'INTEGER ' . $oHelper->GetAutoIncrementDefinition();
				break;
			case CDbField::AUTO_INT_BIG:
				$sResult .= 'INTEGER ' . $oHelper->GetAutoIncrementDefinition();
				break;
			case CDbField::AUTO_INT_UNSIGNED:
				$sResult .= 'INTEGER ' . $oHelper->GetUnsignedDefinition() . ' ' . $oHelper->GetAutoIncrementDefinition();
				break;
			...
			case CDbField::INT_UNSIGNED:
				$sResult .= 'int(11) ' . $oHelper->GetUnsignedDefinition();
				break;
			...
			case CDbField::INT_BIG_UNSIGNED:
				$sResult .= 'bigint ' . $oHelper->GetUnsignedDefinition();
				break;
