...
class WorkOrder
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Timesheet", mappedBy="workOrder")
     */
    ...
    /**
     * @ORM\Column(name="Other_Job_Requirement", type="string")
     * @Serializer\Expose
     */
    protected $otherRequirements;    
