...
class DashboardController extends Controller
{
    ...
    public function dashboardAction(Request $request, $bridge = false)
    {
        ...
        $this->get('session')->save(); //By disabling this, it appears to have made the site slightly slower in loading the datatables etc.
        ...
        return $this->render(
            '@MirsaMirsa/Dashboard/dashboard.html.twig',
